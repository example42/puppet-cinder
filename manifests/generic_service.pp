# Define cinder::generic_service
#
# This class implements basic ceilomer services.
# It is derived from https://github.com/stackforge/puppet-cinder/blob/master/manifests/generic_service.pp
#
define cinder::generic_service (
